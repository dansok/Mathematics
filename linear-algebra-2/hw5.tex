...
0 & C^k
\end{pmatrix}$. Thus,
$$p(G) = c_0 + c_1 G + \ldots + c^k G^k + \ldots + c_n G^n = $$
$$c_0 + c_1\begin{pmatrix}
B & 0 \\
0 & C
...
\end{pmatrix} =$$
$$\begin{pmatrix}
c_0 + c_1 B + \ldots + c_k B^k + \ldots + c_n B^n & 0 \\
0 & c_0 + c_1 C + \ldots + c_k C^k + \ldots + c_n C^n 
\end{pmatrix} =$$
$$\begin{pmatrix}
p(B) & 0 \\
0 & p(C)
...
$$p_A(A) = p_A(SJS^{-1}) = c_0 + c_1 SJS^{-1} +c_2 (SJS^{-1})^2 + \ldots + c_n (SJS^{-1})^n =$$
$$c_0 + c_1 SJS^{-1} +c_2 (SJS^{-1})^2 + \ldots + c_n (SJS^{-1})^n =$$
$$c_0 + c_1 SJS^{-1} +c_2 SJ^2S^{-1} + \ldots + c_n SJ^nS^{-1} =$$
$$S(c_0 + c_1 J +c_2 J^2 + \ldots + c_n J^n)S^{-1} =$$
