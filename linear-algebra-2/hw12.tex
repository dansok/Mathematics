...
I_t & 0 \\
0 & 0
\end{pmatrix} $. That is, $A, B$ are isometric. I.e., $A, B$ preserve the norms of vectors in their row spaces.
Now consider the matrix $M = A^TB$. For $v, w \in X$, by question $\mathbf{(1)(a)}$ in homework $11$, we have $v \in N_B^{\perp}, w \in N_A^{\perp}$. Therefore,
...
Where $z= Bv, y = Aw$, and $\|z\| = \|Bv\| = \|v\| = 1 = \|w\| = \|Aw\| = \|y\|$. Therefore, $M = A^TB$ is the desired matrix.
\end{proof}
