...
Now consider the matrix $M = A^TB$. For $v, w \in X$, by question $\mathbf{(1)(a)}$ in homework $11$, suffices to consider $v \in N_B^{\perp}, w \in N_A^{\perp}$. Then we denote $z= Bv, y = Aw$, and therefore and $\|z\| = \|Bv\| = \|v\| = 1 = \|w\| = \|Aw\| = \|y\|$. Thus,
